            ...
            <div className="mt-6 flex items-center gap-3">
              {socials.map((s) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full border border-neutral-700 text-neutral-400 transition-colors duration-150 hover:border-white hover:text-white"
                >
                  <svg
